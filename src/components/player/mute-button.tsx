...
export function MuteButton({ player }: { player: PlayerAPI }) {
    return (
        <button
            type="button"
            className="group relative rounded-md hover:bg-primary focus:outline-none  md:order-none"
        ...
        >
            ...
            <MuteIcon
                muted={player.muted}
                className="h-6 w-6 fill-primary stroke-primary group-hover:fill-primary hover:fill-secondary hover:stroke-secondary hover:group-hover:fill-secondary"
            />
        </button>
    );
}
